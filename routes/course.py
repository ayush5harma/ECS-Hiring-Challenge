...
import data
from run import app
from structure.validator import DataModel
...
def get_course(id):
    ...
    """
    # Using Binary Search to find course instead of linear scan.
    course_index = search_course(id)
    if course_index:
...
def create_course():
    ...
    """
    # YOUR CODE HERE
    create_course_schema = DataModel()
